...
function theme_enqueue_assets() {
  ...
  wp_enqueue_script('lenis', "https://unpkg.com/lenis@1.1.11/dist/lenis.min.js", [], null, true);
  ...
  wp_enqueue_script('gsap', get_template_directory_uri() . '/plugin/gsap/gsap.min.js', [], null, true);
  wp_enqueue_script('gsap-scroll', get_template_directory_uri() . '/plugin/gsap/ScrollTrigger.min.js', [], null, true);
  wp_enqueue_script('animation-core', get_template_directory_uri() . '/plugin/gsap/index.js', [], null, true);
    ...
    if ($query->have_posts()) :
        while ($query->have_posts()) : $query->the_post();
            ...
            <a href="<?php the_permalink(); ?>" class="newsdetail_other_item<?php echo esc_attr($class); ?>">
                <div class="newsdetail_other_item_img img_fullfill">
